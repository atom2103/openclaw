...
- Agents/Streaming: keep Markdown links, images, bare URLs, and angle autolinks intact across streamed reply chunks, preventing long destinations from being split into unusable fragments. Fixes #151147.
